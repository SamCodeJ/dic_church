    ...
    class Member{
        ...
        public function addMember(){
            ...
            if($this->isUserNameChosen($this->username)){
                return json_encode(array("code" => 409,"message"=>"Username already Chosen"));
            }else{
        ...
        public function verifyMember(){
            ...
            if(!$this->isUserNameChosen($this->username)){
                return json_encode(array("code"=>404,"message"=>"User not Found"));
            }else{
                ...
                if($select_user_details_result=$this->conn->query($select_user_details_query)){
                     //
                        ...
                        if(password_verify($this->member_password,$member_password)){//verify the password
                            ...
                            return json_encode(array("code"=>401,"message"=>"Incorrect Password"));
                        }
                }else{
                    return json_encode(array("code"=>500,"message"=>$conn->error));
                }
            }
        }
        ...
        public function getAllMembers(){
            $select_all_members_query="SELECT membership_id,first_name, middle_name, last_name, email_address, phone_number, username FROM $this->tableName";
            if($select_all_members_result=$this->conn->query($select_all_members_query)){
                ...
                array_push($returned_array,$member_array);
